  ...
  return (
    <Box className="max-w-7xl mx-auto p-4 space-y-6 animate-in fade-in duration-700 bg-transparent">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-[var(--card-border)]">
        <Stack gap="none">
          <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-[var(--text)]">
            Active Sessions
          </h2>
          <div className="flex items-center gap-1.5">
            <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,0.5)]" />
            <span className="text-[8px] font-bold uppercase tracking-widest text-[var(--text-secondary)] opacity-60">Management Console</span>
          </div>
        </Stack>
        <button
          onClick={handleGenerateToken}
          disabled={isGenerating}
          className="px-3.5 py-1.5 md:py-2 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 text-[var(--text)] border border-[var(--card-border)] rounded-sm transition-all flex items-center gap-2.5 group shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <div className="w-4 h-4 rounded-full bg-cyan-500/10 flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors">
            <Plus size={12} strokeWidth={3} className="text-cyan-600 transition-transform group-hover:rotate-90 duration-300" />
          </div>
          <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)] group-hover:text-cyan-600 transition-colors">
