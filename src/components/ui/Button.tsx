...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const baseClasses = 'inline-flex items-center justify-center rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-400/50 disabled:opacity-50 disabled:cursor-not-allowed';
